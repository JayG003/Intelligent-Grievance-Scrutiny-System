...
public class UserDashboard extends JFrame{
    ...
    String user = "Jay Ware";
    String role = "Grievancer";
    ...
    void AddPanels(){
        ...
        ImageIcon btn1 = new ImageIcon("dashboard icon.png");
        ...
        // dashBtn.setBackground(new Color(45, 85, 155));
        ...
        ImageIcon btn2 = new ImageIcon("form.png");
        ...
        ImageIcon btn3 = new ImageIcon("mygrivances.png");
        ...
        ImageIcon btn4 = new ImageIcon("bell.png");
        ...
        ImageIcon btn5 = new ImageIcon("profile.png");
        ...
        ImageIcon btn6 = new ImageIcon("logout.png");
        ...
        // RPanel.setBackground(new Color(25,25,35));
        // RPanel.setBackground(new Color(17,24,39));
        ...
        // RlabelP.setBackground(new Color(25,25,35));
        ...
        dashBtn.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                dashBtn.setBackground(new Color(45, 110, 155));
            }
        ...
        grievBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(
                    null,
                    "Submite Grievance feature is in progress",
                    "messege",
        ...
        mygrievBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(
                    null,
                    "My grievance feature is in progress",
                    "messege",
                    JOptionPane.INFORMATION_MESSAGE
                );
            }
        ...
        notifyBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(
                    null,
                    "Notification feature is in progress",
                    "messege",
                    JOptionPane.INFORMATION_MESSAGE
                );
            }
